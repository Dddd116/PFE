...
class AlarmsPage(QWidget):
    ...
    def setup_ui(self):
        ...
        self.title_label = QLabel("ALARMES")
    ...
    def create_stats_section(self):
        ...
        self.normal_card = self.create_stat_card("0", self.colors["success"])
        self.warning_card = self.create_stat_card("0", self.colors["warning"])
        self.critical_card = self.create_stat_card("0", self.colors["danger"])
    ...
    def create_alarms_card(self):
        ...
        self.middle_title = QLabel("ALARMES")
        self.middle_title.setObjectName("titleLabel")
        self.middle_title.setAlignment(Qt.AlignCenter)

        self.alarm_list = QListWidget()
        self.alarm_list.setMinimumHeight(260)
    ...
    def create_stat_card(self, value, color):
        frame = QFrame()
    ...
    def refresh_page(self):
        ...
        if not has_alarm:
            ...
            self.status_message.setText(
                f"Attention : {warning_count} | Critique : {critical_count}"
            )